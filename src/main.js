...
const routes = [
...

  {
    ...
    component: CreateCryptogram,
    name: "create_cryptogram",
  },
  {
    path: "/search-cryptogram",
    component: SearchCryptogram,
