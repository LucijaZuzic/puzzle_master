...
<template>
      ...
      <div class="my_row">
        <va-tabs>
          <template #tabs>
            ...
            <va-tab v-if="edit">
              <router-link
                v-bind:to="{ name: 'solve_number_crossword', params: { id: $route.params.id } }"
              >
  ...
  <va-modal
    ...
    stateful
  >
    <NumberCrossowrdInfo></NumberCrossowrdInfo>
  </va-modal>
</template>
