...
<template>
  ...
  <br />
  <span class="tab"></span>
  Zagonetci zadajemo broj redaka, stupaca i broj boja. Maksimalni broj redaka je
  50, a isto vrijedi i za stupce i za boje.
  <br />
  <br />

  <h6 class="display-6">Boje</h6>
  <br />
  ...
  <h6 class="display-6">Način bojanja</h6>
  <br />
