...
<template> 
  ...
  polja kojima odabrana vrijednost kategorije za pojam ne odgovara rješenju.
  Svaki put kada se zagonetka rješava redoslijed kategorija i pojmova se nasumično
  generira.
  ...
  <h6 class="display-6">Pomoćna tablica</h6>
  <br />
  ...
  <span class="tab"></span>
  Prema pomoćnoj tablici, gdje su prikazane kvačice, križići ili upitnici, generira se još jedna tablica gdje su  pod naslovom kategorije u svakom stupcu prikazane
  vrijednosti ili kratice za pojam koji je predstavljen retkom. 
  ...
  <h6 class="display-6">Kratice</h6>
  <br />

  <span class="tab"></span> 
  Riječi dulje od 20 znakova biti će prikazane kraticom koja se sastoji od broja kategorije i slova A, B, C, D ili E koje označava broj pojma unutar kategorije.
