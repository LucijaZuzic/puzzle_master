...
<template>   
  ...
  <CryptogramTable :friend="user" v-if="value=='author' && authorCryptogram.length > 0" selectMode="single" :puzzleList="authorCryptogram"></CryptogramTable> 
  <NoDataToDisplay v-if="value=='author' && authorCryptogram.length <= 0" customMessage="Korisnik nije autor niti jednog kriptograma"></NoDataToDisplay> 
  <CryptogramTable :friend="user" v-if="value=='updater' && updaterCryptogram.length > 0" selectMode="single" :puzzleList="updaterCryptogram"></CryptogramTable>
  <NoDataToDisplay v-if="value=='updater' && updaterCryptogram.length <= 0" customMessage="Korisnik nije zadnji ažurirali niti jedan kriptogram"></NoDataToDisplay>  
