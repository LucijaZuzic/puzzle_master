  ...
  methods: {
                                                ...
                                                snapshotCurrentUser.forEach(
                                                  function (
                                                    ...
                                                    if (
                                                      ...
                                                      let favorite = {
                                                        favorite:
                                                          me.favoriteNumberCrosswords.includes(
                                                            childSnapshot.id
                                                          ),
                                                        id: childSnapshot.id,
                                                      };
    ...
    add_favorite(id) {
      ...
      usersRef
        ...
        .set(
          {
            favoriteNumberCrosswords: this.favoriteNumberCrosswords,
          },
          { merge: true }
        )
        .then(() => {
      ...
      numberCrosswordsRef
        ...
        .then(() => {
          numberCrosswordsRatingsRef
            ...
            .then(() => {
              numberCrosswordsRecordsRef.get().then(function (snapshotRecord) {
        ...
        .then(() => {
          ...
          const listRef = ref(projectStorage, "numberCrossword/");
    ...
    <span v-if="puzzles.length > 0">
      ...
      <va-data-table
        ...
        @selectionChange="
          ...
          $emit('selectedNumberCrosswords', selectedItemsEmitted);
        "
      ...
      >
        ...
        <template #cell(id)="{ source: id }">
          <router-link
            v-bind:to="{ name: 'solve_number_crossword', params: { id: id } }"
          >
    ...
    >
      ...
      <span v-for="item in selectedItemsEmitted" :key="item.id">
        <RatingsTable
          v-if="value == 'rate'"
          :type="'all'"
          :dbRef="numberCrosswordsRatingsRef"
        ...
        <RecordsTable
          v-if="value == 'all'"
          :type="'all'"
          :dbRef="numberCrosswordsRecordsRef"
          :puzzleId="selectedItemsEmitted[0].id"
        >
        </RecordsTable>
        <RecordsTable
