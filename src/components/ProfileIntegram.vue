...
<template>
  ...
  <IntegramTable :friend="user" v-if="value=='author' && authorIntegram.length > 0" selectMode="single" :puzzleList="authorIntegram"></IntegramTable> 
  <NoDataToDisplay v-if="value=='author' && authorIntegram.length <= 0" customMessage="Korisnik nije autor niti jednog integrama"></NoDataToDisplay> 
  <IntegramTable :friend="user" v-if="value=='updater' && updaterIntegram.length > 0" selectMode="single" :puzzleList="updaterIntegram"></IntegramTable>
  <NoDataToDisplay v-if="value=='updater' && updaterIntegram.length <= 0" customMessage="Korisnik nije zadnji ažurirali niti jedan integram"></NoDataToDisplay>  
