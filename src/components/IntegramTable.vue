...
import { integramsRecordsRef, integramsRatingsRef } from "../firebase_main.js";
  ...
  methods: {
            ...
            if (inList == true) {
              ...
              integramsRatingsRef
                ...
                .then(() => {
                  ...
                  let category_values = funct_ref(
                    childSnapshot.get("category_values").replace(",", ",")
                  );
                  usersRef
    ...
    add_favorite(id) {
      ...
      usersRef
        ...
        .set(
          {
            favoriteIntegrams: this.favoriteIntegrams,
          },
          { merge: true }
        )
        .then(() => {
    ...
    <span v-if="puzzles.length > 0">
      ...
      <va-data-table
        ...
        @selectionChange="
          ...
          $emit('selectedIntegrams', selectedItemsEmitted);
        "
