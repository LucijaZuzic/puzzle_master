...
import { numberLettersRecordsRef, numberLettersRatingsRef } from "../firebase_main.js"
                                    ...
                                    friendsRef
                                      ...
                                      .then(() => {
                                        ...
                                        me.puzzles.push({
                                          ...
                                          letters:
                                            childSnapshot.get("letters").length,
...
<template>
  ...
  <va-data-table
    ...
    @selectionChange="
      ...
      $emit('selectedNumberLetters', selectedItemsEmitted);
    "
