...
<template>
  <va-tabs v-model="value" vertical>
      <template #tabs> 
      <va-tab
          label="Nonogrami kojima je korisnik autor"
          name="author"
      />
      <va-tab
          label="Nonogrami koje je korisnik zadnji ažurirao"
          name="updater"
      />
      <va-tab
          label="Nonogrami na kojima je korisnik suradnik"
          name="collaborator"
      />
      <va-tab
          label="Nonogrami koje je korisnik riješio"
          name="record"
      />
      </template>
  </va-tabs>
  ...
  <NoDataToDisplay v-if="value=='record' && recordNonogram.length <= 0" customMessage="Korisnik nije riješili niti jedan nonogram"></NoDataToDisplay> 
</template>
